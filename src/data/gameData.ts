...
export const ZONES: Zone[] = [
  {
    ...
    backgroundImage: '/assets/cartoon_meadow.png',
  ...
  },
  {
    ...
    requiredLevel: 3,
    maxCreatures: 5,
    backgroundTheme: 'from-cyan-900/70 to-teal-950',
    backgroundImage: '/assets/tropical_island.png',
    description: 'Лазурный тропический остров с лагунами, пальмами и бабочками (+5 мест для существ).',
  },
  {
    id: 3,
    ...
    requiredLevel: 5,
    maxCreatures: 5,
    backgroundTheme: 'from-purple-950/80 via-slate-950 to-indigo-950',
    backgroundImage: '/assets/cyberpunk_city.png',
    description: 'Футуристичный мегаполис с эстакадами, парящими сферами, сакурами и голограммами (+5 мест для существ).',
  },
  {
    id: 4,
    name: 'Лавовые Земли',
    ...
    backgroundImage: '/assets/volcano_magma.png',
  ...
  },
  {
    ...
    backgroundImage: '/assets/cosmic_station.png',
